				...
				<form id="tform" class="form-horizontal" role="form" action="feed.php" method="GET">
					<div class="form-group">
						<div class="input-group input-group-lg">
							...
							<input type="url" id="url" name="url" class="form-control search-query" placeholder="URL" <?php if (isset($_GET['url'])) {echo 'value="'.$url.'"';} ?> required>
						...
						<div class="panel panel-default" style="margin-top: 20px;">
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input name="title" id="title" class="form-control" placeholder="Simple HTML DOM find string" <?php if (isset($_GET['title'])) {echo 'value="'.$title.'"';} ?> required>
									</div>
								</div>
								<div class="form-group">
									<label for="link" class="col-sm-3 control-label">Link:</label>
									<div class="col-sm-4">
										<input name="link" id="link" class="form-control" placeholder="Simple HTML DOM find string" <?php if (isset($_GET['link'])) {echo 'value="'.$link.'"';} ?> required>
									</div>
								</div>
								<div class="form-group">
									<label for="author" class="col-sm-3 control-label">Author:</label>
									<div class="col-sm-4">
										<input name="author" id="author" class="form-control" placeholder="Simple HTML DOM find string" <?php if (isset($_GET['author'])) {echo 'value="'.$author.'"';} ?> required>
									</div>
								</div>
								<div class="form-group">
									<label for="date" class="col-sm-3 control-label">Publish date:</label>
									<div class="col-sm-4">
										<input name="date" id="date" class="form-control" placeholder="Simple HTML DOM find string" <?php if (isset($_GET['date'])) {echo 'value="'.$date.'"';} ?> >
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="content_filters" class="col-sm-3 control-label">Filters (string or regex) for remove unnecessary strings in content:</label>
									<div class="col-sm-6">
										<textarea name="content_filters" id="content_filters" class="form-control" wrap="off" rows="4" placeholder="one filter per lines"><?php if (isset($_GET['content_filters'])) {echo $content_filters;} ?></textarea>
									</div>
								</div>
							</div>
						</div>
